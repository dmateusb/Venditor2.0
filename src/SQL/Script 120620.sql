...
CREATE TABLE IF NOT EXISTS `venditor`.`contratos` (
  ...
  `Sobreprecio_real` INT(15) NULL,
  `Sobreprecio_cobrado` INT(15) NULL,
...
CREATE TABLE IF NOT EXISTS `venditor`.`descuentos` (
  `Id` INT(11) NOT NULL AUTO_INCREMENT,
  `Numero_contrato` INT(20) NULL DEFAULT NULL,
  `Precio_real` INT(20) NULL DEFAULT NULL,
  `Precio_cobrado` INT(20) NULL DEFAULT NULL,
  `Razon` VARCHAR(150) NULL DEFAULT NULL,
